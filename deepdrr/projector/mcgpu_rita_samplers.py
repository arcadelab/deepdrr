from .mcgpu_rita_params.adipose_rita_params import adipose_ICRP110_RITA_PARAMS as ADIPOSE_RITA_PARAMS
from .mcgpu_rita_params.air_rita_params import air_RITA_PARAMS as AIR_RITA_PARAMS
from .mcgpu_rita_params.blood_rita_params import blood_ICRP110_RITA_PARAMS as BLOOD_RITA_PARAMS
from .mcgpu_rita_params.bone_rita_params import bone_ICRP110_RITA_PARAMS as BONE_RITA_PARAMS
from .mcgpu_rita_params.brain_rita_params import brain_ICRP110_RITA_PARAMS as BRAIN_RITA_PARAMS
from .mcgpu_rita_params.breast_rita_params import breast_RITA_PARAMS as BREAST_RITA_PARAMS
from .mcgpu_rita_params.cartilage_rita_params import cartilage_ICRP110_RITA_PARAMS as CARTILAGE_RITA_PARAMS
from .mcgpu_rita_params.connective_rita_params import connective_Woodard_RITA_PARAMS as CONNECTIVE_RITA_PARAMS
from .mcgpu_rita_params.glands_others_rita_params import glands_others_ICRP110_RITA_PARAMS as GLANDS_OTHERS_RITA_PARAMS
from .mcgpu_rita_params.liver_rita_params import liver_ICRP110_RITA_PARAMS as LIVER_RITA_PARAMS
from .mcgpu_rita_params.lung_rita_params import lung_ICRP110_RITA_PARAMS as LUNG_RITA_PARAMS
from .mcgpu_rita_params.muscle_rita_params import muscle_ICRP110_RITA_PARAMS as MUSCLE_RITA_PARAMS
from .mcgpu_rita_params.PMMA_rita_params import PMMA_RITA_PARAMS
from .mcgpu_rita_params.red_marrow_rita_params import red_marrow_Woodard_RITA_PARAMS as RED_MARROW_RITA_PARAMS
from .mcgpu_rita_params.skin_rita_params import skin_ICRP110_RITA_PARAMS as SKIN_RITA_PARAMS
from .mcgpu_rita_params.soft_tissue_rita_params import soft_tissue_ICRP110_RITA_PARAMS as SOFT_TISSUE_RITA_PARAMS
from .mcgpu_rita_params.stomach_intestines_rita_params import stomach_intestines_ICRP110_RITA_PARAMS as STOMACH_INTESTINES_RITA_PARAMS
from .mcgpu_rita_params.titanium_rita_params import titanium_RITA_PARAMS as TITANIUM_RITA_PARAMS
...
rita_samplers = {
    ...
    "stomach intenstines": RITA.from_saved_params(saved_rita_params["stomach intestines"]),
...
def sanity_check_saved_rita_params():
    ...
    print("The saved RITA parameters' sanity has been checked!")
